                        ...
                        <ol>
                            ...
                            <li>The following progress payments for which the claimant has previously given a conditional waiver and release but has not received payment:</li>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" placeholder="Date(s) of waiver and release" name="date_of_waiver" >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Amount(s) of unpaid progress payment(s): $</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Amount(s) of unpaid progress payment(s) $" name="amount_of_unpaid_progress_payments" >
                                    </div>
                                </div>
                            </li>
                            <li>
