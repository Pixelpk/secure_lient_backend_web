      ...
      <section id="form-section" class="form-section" style="height: 100%">
          <div class="container">
                ...
                <form action="" method="POST" onSubmit="submitForm();" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="form_no" value="{{ $form6->form_no }}"/>
                    <div class="row">
                        <div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Name of Owner" name="owner_name" value="{{ $form6->owner_name }}" required autofocus>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Owner Phone:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Owner Phone" name="owner_phone" value="{{ $form6->owner_phone }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Date:</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" placeholder="Date" name="owner_date" value="{{ $form6->owner_date }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Owner Address:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Owner Address" name="owner_address" value="{{ $form6->owner_address }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Job Name:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Job Name" name="job_name" value="{{ $form6->job_name }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Job No:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Job No" name="job_no" value="{{ $form6->job_no }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Owner City:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Owner City" name="owner_city" value="{{ $form6->owner_city }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Owner State:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Owner State" name="owner_state" value="{{ $form6->owner_state }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Other Address:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Other Address" name="other_address" value="{{ $form6->other_address }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Existing Contract No:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Existing Contract No" name="existing_contract_no" value="{{ $form6->existing_contract_no }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Existing Contract Date:</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" placeholder="Existing Contract Date" name="date_of_existing_contract" value="{{ $form6->date_of_existing_contract }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">City:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="City" name="other_city" value="{{ $form6->other_city }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">State:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="State" name="other_state" value="{{ $form6->other_state }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Description:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="We hereby agree to the specified changes and charges listed below" name="note" value="{{ $form6->note }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="Additional Charge for abouve work is $" name="payment" value="{{ $form6->payment }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Payment to be made ad follows:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="Payment to be made ad follows" name="payment_note" value="{{ $form6->payment_note }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="Change Order No" name="change_order_no" value="{{ $form6->change_order_no }}" required>
                        </div>
                    </div>
