          ...
          <div class="container">
                ...
                <form action="" method="POST" onSubmit="submitForm();" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="$10,975.00 Total Paid" name="document_effect" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Disputed claims for extras in the amount of: $</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="0.00" name="extra_amount" required>
                        </div>
                    </div>
