      ...
      <section id="form-section" class="form-section">
          <div class="container">
                ...
                <form action="" method="POST" onSubmit="submitForm();" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="form_no" value="{{ $form5->form_no }}"/>
                    <div class="row">
                        <div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" placeholder="Date of Signature" name="signature_date" value="{{ $form5->signature_date }}" disabled required>
                        </div>
                    </div>
